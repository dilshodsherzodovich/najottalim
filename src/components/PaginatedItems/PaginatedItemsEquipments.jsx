...
import Equipment from "../../pages/Equipments/component/Equipment";

// images & icons
import { AiFillCaretLeft, AiFillCaretRight } from "react-icons/ai";

const PaginatedItemsEquipments = ({ data, itemsPerPage }) => {
  const items = data;
  ...
  return (
    <>
      <Items
        ...
        design={<Equipment EquipmentInfo={currentItems} />}
      />
...
export default PaginatedItemsEquipments;
